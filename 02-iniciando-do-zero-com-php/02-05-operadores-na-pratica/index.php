...
$logic = [
    "a && " => ($logicA && $logicB), //$logicA e $logicB existem? r=false
    "a || " => ($logicA || $logicB),  //$logicA ou $logicB existem? r=true
    "a" => ($logicA),
    "! a" => (!$logicA), //A váriavel $logicA existe? (existe sim) r= false
    "! a" => (!$logicB) //A váriavel $logicA existe? (não existe) r= true
];
