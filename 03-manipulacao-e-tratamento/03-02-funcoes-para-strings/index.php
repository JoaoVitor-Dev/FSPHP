...
var_dump([
    "string" => $string,
    "strlen" => strlen($string), //conta os caracteres (não reconhece ascentos)
    "mb_strlen" => mb_strlen($string), //conta os caracteres (reconhece ascentos)
...
var_dump([
    "strtoupper" => mb_strtoupper($mbString), //todas as letras em maiscula
    "strtolower" => mb_strtolower($mbString), //todas as letras em minuscula
...
var_dump([
    ...
    "mb_strrpos" => mb_strpos($mbReplace, ", "),
